        ...
        <div class="container-fluid my-5">
          <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg">
            <div class="col-lg-7 p-3 p-lg-5 pt-lg-3">
              <h1 class="display-4 fw-bold lh-1">Covid - 19</h1>
              <p class="lead">Coronaviruses (CoV) are a large family of viruses that cause illness ranging from the common cold to more severe diseases. A novel coronavirus (nCoV) is a new strain that has not been previously identified in humans.</p>
            </div>
            <div class="col-lg-4 offset-lg-1 p-0 overflow-hidden shadow-lg primary" >
                <img class="rounded-lg-3" src="assets/img/corona.png" alt="" width="600px" height="400px">
            </div>
            <div>
            <?php
        $sql = "SELECT disease, summary, fund1, fund2, research1, research2, research3, institution1, institution2 FROM mp WHERE disease='corona'";
